// Este ficheiro contém o HTML para as diferentes partes da aplicação.
...
const Views = {
        ...
        <main class="flex-grow overflow-y-auto">
            ...
            <div id="vender-view" class="tab-content p-4">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md flex flex-col mt-4">
                    ...
                    <div class="mt-2 pt-2 border-t">
                        <div class="space-y-3">
                            <h4 class="text-md font-semibold text-gray-700">Pagamento</h4>
                            <div id="payment-entries" class="space-y-2"></div>
                            <div class="flex items-end gap-2">
                                <div class="flex-1">
                                    <label for="payment-method-select" class="block text-xs font-medium text-gray-600">Método</label>
                                ...
                                <div class="flex-1">
                                    <label for="payment-amount-input" class="block text-xs font-medium text-gray-600">Valor</label>
                        ...
                        <div class="mt-4 space-y-1 text-sm">
                            ...
                            <div id="discount-info" class="hidden text-green-600 flex justify-between"><span>Desconto (5%):</span><span id="discount-amount">- R$ 0,00</span></div>
            ...
            <div id="config-view" class="tab-content p-4 hidden">
                <div class="bg-white w-full rounded-xl shadow-md p-6">
                    ...
                    <p class="text-center text-gray-600 mt-4">Utilizador logado: <span id="current-user-info" class="font-semibold"></span></p>
    ...
    <!-- MODAL DO SCANNER -->
    <div id="scanner-modal" class="fixed inset-0 w-full h-full flex items-center justify-center hidden z-50 p-4 modal-bg"><div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full"><div class="flex justify-between items-center mb-4"><h2 class="text-xl font-bold text-gray-800">Aponte para o Código</h2><button id="close-scanner-btn" class="text-gray-500 hover:text-gray-800 text-2xl leading-none">&times;</button></div><div id="scanner-container" class="relative scanner-container"><div id="scanner-viewport" class="scanner-viewport"></div></div></div></div>
    ...
    <div id="add-product-modal" class="fixed inset-0 w-full h-full flex items-center justify-center hidden z-50 p-4 modal-bg">
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full overflow-y-auto max-h-full">
            ...
            <div id="add-product-scanner-container" class="relative hidden mb-4 bg-gray-200 rounded-lg scanner-container"><div id="add-product-scanner-viewport" class="scanner-viewport"></div></div>
    ...
    <div id="pair-product-modal" class="fixed inset-0 w-full h-full flex items-center justify-center hidden z-50 p-4 modal-bg">
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full overflow-y-auto max-h-full">
            ...
            <div id="pair-product-scanner-container" class="relative hidden mb-4 bg-gray-200 rounded-lg scanner-container"><div id="pair-product-scanner-viewport" class="scanner-viewport"></div></div>
            <div class="space-y-4">
    ...
    <div id="adjust-stock-modal" class="fixed inset-0 w-full h-full flex items-center justify-center hidden z-50 p-4 modal-bg">
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full overflow-y-auto max-h-full">
            ...
            <div id="adjust-stock-scanner-container" class="relative hidden mb-4 bg-gray-200 rounded-lg scanner-container"><div id="adjust-stock-scanner-viewport" class="scanner-viewport"></div></div>
            <div class="space-y-4">
                <div>
...
// Injeta as views assim que o script for carregado
injectViews();
